  ...
  <div class="container-fluid">
    ...
    <div class="container">
      ...
      <div class="col-lg-10">
        <div class="card">
          <div class="card-body">
            <h5 class="card-title">Show Child Detail</h5>
                ...
                <tbody>
                  ...
                  ?>
                      ...
                      <tr>
                        ...
                        <td>
                          <a href="./logic.php?status=approved&&id=<?php echo $row['id'] ?>">Approved</a>
                          <a href="./logic.php?status=reject&&id=<?php echo $row['id'] ?>">Reject</a>
                        </td>
